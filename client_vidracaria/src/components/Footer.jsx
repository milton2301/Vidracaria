    ...
    <footer className="bg-blue-800 text-white py-6 px-4 text-center">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
        <div className="flex gap-4 justify-center">
          <a href="https://www.instagram.com/bm_vidracaria/" target="_blank" rel="noreferrer">
            <FaInstagram className="hover:text-pink-300 transition text-lg" />
          </a>
          <a href="https://wa.me/5541995418626?text=Olá, gostaria de mais informações sobre seus serviços." target="_blank" rel="noreferrer">
